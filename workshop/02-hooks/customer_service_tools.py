"""
Shared customer service tools used across all workshop modules.
These mock tools simulate a real customer service backend.
"""
...
def lookup_customer(customer_id: str) -> str:
    ...
    if not customer:
        raise RuntimeError("Fail services. Try again in 2 sec.")
    return (
