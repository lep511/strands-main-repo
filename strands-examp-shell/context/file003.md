...
source: "https://strandsagents.com/docs/user-guide/shell/commands/"
author:
  - "[[Strands Agents]]"
published:
created: 2026-07-10
...
The SSRF guard and credential injection on `curl` are security features, covered in the [security model](https://strandsagents.com/docs/user-guide/shell/security/). They are not optional and cannot be disabled per command.
